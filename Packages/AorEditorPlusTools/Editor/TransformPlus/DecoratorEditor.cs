...
namespace AORCore.Editor
{

    /// <summary>
    /// A base class for creating editors that decorate Unity's built-in editor types.
    /// 注意: 不要使用此类去反射属于UGUI的Editor. 
    /// </summary>
    public abstract class DecoratorEditor : UnityEditor.Editor
    {
        ...
        protected UnityEditor.Editor EditorInstance
        {
            get
            {
                ...
                if (_decoratedError) return null;
        ...
        public DecoratorEditor(string editorTypeName)
        {
            ...
            if (this.decoratedEditorType == null)
            {
                _decoratedError = true;
                return;
            }
        ...
        protected virtual void Awake()
        {
            ...
            //Debug.Log("*DecoratorEditor.Awake()");
        }

        protected virtual void OnEnable()
        {
            CallInspectorMethod("OnEnable");
           //Debug.Log("*DecoratorEditor.OnEnable()");
        }
        ...
        protected virtual void OnDisable()
        {
            ...
            //Debug.Log("*DecoratorEditor.OnDisable()");
        }
