...
//        }
        ...
        public override void DrawNodeInspector(float inspectorWidth)
        {
            ...
            if (Advanced)
            {
                ...
                string[] keylist = (string[]) m_nodeGUI.data.GetPublicField("FilterKeys");
                bool[] icList = (bool[]) m_nodeGUI.data.GetPublicField("IgnoreCase");
                ...
                if (keylist != null)
                {
                    ...
                    if (_ischanged)
                    {
                        m_nodeGUI.data.SetPublicField("FilterKeys", keylist);
                        m_nodeGUI.data.SetPublicField("IgnoreCase", icList);
                    }
                }
            ...
            string[] assetPaths = (string[])m_nodeGUI.data.GetPublicField("AssetsPath");
        ...
        private void _changeFKMode(int mode)
        {
            ...
            {
                m_nodeGUI.data.SetPublicField("FilterKeys", keys.ToArray());
                m_nodeGUI.data.SetPublicField("IgnoreCase", IgnoreCs.ToArray());
            }
            else
            {
                m_nodeGUI.data.SetPublicField("FilterKeys", null);
                m_nodeGUI.data.SetPublicField("IgnoreCase", null);
            }
