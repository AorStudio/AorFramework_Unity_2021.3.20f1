...
using System.IO;
//using UnityEngine.Rendering.Universal.PlayerInput;
...
#pragma warning restore 0649
		...
		private void LateUpdate()
		{
			...
			if( isLogWindowVisible && commandInputField.isFocused )
			{
				...
				////hack by Aoriton
				////当ShowLogWindow打开时禁用PlayerInpuptManager.防止按键功能的重复定义
				//if (PlayerInputManager.Instance && PlayerInputManager.Instance.enabled)
