...
namespace RootMotion.FinalIK {
	...
	public class GrounderQuadruped: Grounder {
		...
		/// <summary>
		/// The EffectWeight of rotating the character root to the ground angle (range: 0 - 1).
		/// </summary>
		[Tooltip("The EffectWeight of rotating the character root to the ground angle (range: 0 - 1).")]
		[Range(0f, 1f)]
		...
		/// <summary>
		/// The EffectWeight of maintaining the head's rotation as it was before solving the Grounding (range: 0 - 1).
		/// </summary>
		[Tooltip("The EffectWeight of maintaining the head's rotation as it was before solving the Grounding (range: 0 - 1).")]
		[Range(0f, 1f)]
		...
		// Set the IK position and EffectWeight for a limb
