...
namespace RootMotion.FinalIK {
	...
	public partial class Grounding {
		...
		/// <summary>
		/// The EffectWeight of lowering the pelvis to the lowest foot.
		/// </summary>
		[Tooltip("The EffectWeight of lowering the pelvis to the lowest foot.")]
		public float lowerPelvisWeight = 1f;
		/// <summary>
		/// The EffectWeight of lifting the pelvis to the highest foot. This is useful when you don't want the feet to go too high relative to the body when crouching.
		/// </summary>
		[Tooltip("The EffectWeight of lifting the pelvis to the highest foot. This is useful when you don't want the feet to go too high relative to the body when crouching.")]
