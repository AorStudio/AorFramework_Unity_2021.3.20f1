...
namespace RootMotion.FinalIK {
	...
	public class GrounderIK: Grounder {
		...
		/// <summary>
		/// The EffectWeight of rotating the character root to the ground normal (range: 0 - 1).
		/// </summary>
		[Tooltip("The EffectWeight of rotating the character root to the ground normal (range: 0 - 1).")]
		[Range(0f, 1f)]
