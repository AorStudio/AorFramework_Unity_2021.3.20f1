...
namespace RootMotion.FinalIK {
	...
	public class GrounderFBBIK: Grounder {
		...
		public class SpineEffector {
			...
			/// <summary>
			/// The EffectWeight of horizontal bend offset towards the slope..
			/// </summary>
			[Tooltip("The EffectWeight of horizontal bend offset towards the slope.")]
			public float horizontalWeight = 1f;
			/// <summary>
			/// The vertical bend offset EffectWeight.
			/// </summary>
			[Tooltip("The vertical bend offset EffectWeight.")]
			...
			/// <param name="horizontalWeight">Horizontal EffectWeight.</param>
			/// <param name="verticalWeight">Vertical EffectWeight.</param>
