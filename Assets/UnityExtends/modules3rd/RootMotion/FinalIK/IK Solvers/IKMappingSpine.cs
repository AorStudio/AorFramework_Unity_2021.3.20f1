...
namespace RootMotion.FinalIK {
	...
	public class IKMappingSpine: IKMapping {
		...
		/// <summary>
		/// The EffectWeight of twisting the spine bones gradually to the orientation of the chest triangle. Relatively expensive, so set this to 0 if there is not much spine twisting going on.
		/// </summary>
		[Range(0f, 1f)]
