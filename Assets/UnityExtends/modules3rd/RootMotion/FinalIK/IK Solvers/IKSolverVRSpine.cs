...
namespace RootMotion.FinalIK {
	...
	public partial class IKSolverVR: IKSolver {
		...
		public class Spine: BodyPart {
			...
			[Tooltip("Positional EffectWeight of the head target.")]
			/// <summary>
			/// Positional EffectWeight of the head target.
			/// </summary>
			[Range(0f, 1f)] public float positionWeight = 1f;

			[Tooltip("Rotational EffectWeight of the head target.")]
			/// <summary>
			/// Rotational EffectWeight of the head target.
			/// </summary>
			[Range(0f, 1f)] public float rotationWeight = 1f;

			[Tooltip("Positional EffectWeight of the pelvis target.")]
			/// <summary>
			/// Positional EffectWeight of the pelvis target.
			/// </summary>
			[Range(0f, 1f)] public float pelvisPositionWeight;

			[Tooltip("Rotational EffectWeight of the pelvis target.")]
			/// <summary>
			/// Rotational EffectWeight of the pelvis target.
			/// </summary>
			...
			[Tooltip("Rotational EffectWeight of the chest target.")]
			/// <summary>
			/// Rotational EffectWeight of the chest target.
			/// </summary>
