...
namespace RootMotion.FinalIK {
	...
	public class IKMappingLimb: IKMapping {
		...
		/// <summary>
		/// The EffectWeight of maintaining the third bone's rotation as it was in the animation
		/// </summary>
		[Range(0f, 1f)]
		public float maintainRotationWeight;
		/// <summary>
		/// The EffectWeight of mapping the limb to it's IK pose. This can be useful if you want to disable the effect of IK for the limb.
		/// </summary>
		[Range(0f, 1f)]
		...
		public void WritePose(IKSolverFullBody solver, bool fullBody) {
			...
			if (fullBody) {
				if (parentBone != null) {
					...
					//boneMapParent.Swing(boneMap1.node.solverPosition, EffectWeight);
				}
