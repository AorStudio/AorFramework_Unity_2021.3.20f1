...
namespace RootMotion.FinalIK {
	...
	public partial class IKSolverVR: IKSolver {
		...
		public class Leg: BodyPart {
			...
			[Tooltip("Positional EffectWeight of the toe/foot target.")]
			/// <summary>
			/// Positional EffectWeight of the toe/foot target.
			/// </summary>
			[Range(0f, 1f)] public float positionWeight;

			[Tooltip("Rotational EffectWeight of the toe/foot target.")]
			/// <summary>
			/// Rotational EffectWeight of the toe/foot target.
			/// </summary>
