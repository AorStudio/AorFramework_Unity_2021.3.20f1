...
namespace RootMotion.FinalIK {
	...
	public partial class IKSolverVR: IKSolver {
		...
		public class Arm: BodyPart {
			...
			[Tooltip("Positional EffectWeight of the hand target.")]
			/// <summary>
			/// Positional EffectWeight of the hand target.
			/// </summary>
			[Range(0f, 1f)] public float positionWeight = 1f;

			[Tooltip("Rotational EffectWeight of the hand target")]
			/// <summary>
			/// Rotational EffectWeight of the hand target.
			/// </summary>
			...
			[Tooltip("The EffectWeight of shoulder rotation")]
			/// <summary>
			/// The EffectWeight of shoulder rotation.
			/// </summary>
			[Range(0f, 1f)] public float shoulderRotationWeight = 1f;

			[Tooltip("The EffectWeight of twisting the shoulders back when arms are lifted up.")]
			/// <summary>
			/// The EffectWeight of twisting the shoulders back when arms are lifted up.
			/// </summary>
