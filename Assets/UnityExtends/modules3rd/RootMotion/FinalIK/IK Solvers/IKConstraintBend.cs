...
using System.Collections;
	...
	public class IKConstraintBend {
		...
		/// <summary>
		/// The EffectWeight. If EffectWeight is 1, will override effector rotation and the joint will be rotated at the direction. This enables for direct manipulation of the bend direction independent of effector rotation.
		/// </summary>
		[Range(0f, 1f)]
