...
namespace RootMotion.FinalIK {
	...
	public abstract class IKSolver {
		...
		[Tooltip("The positional or the master EffectWeight of the solver.")]
		/// <summary>
		/// The %IK position EffectWeight or the master EffectWeight of the solver.
		/// </summary>
		[Range(0f, 1f)]
		...
		/// <summary>
		/// Gets the %IK position EffectWeight. NOTE: You are welcome to read IKPositionWeight directly, this method is here only to match the Unity's built in %IK API.
		/// </summary>
		...
		/// <summary>
		/// Sets the %IK position EffectWeight. NOTE: You are welcome to set IKPositionWeight directly, this method is here only to match the Unity's built in %IK API.
		/// </summary>
		...
		public class Point {
			...
			/// <summary>
			/// The EffectWeight of this bone in the solver.
			/// </summary>
			[Range(0f, 1f)]
		...
		public class Node: Point {
			...
			public float length;
			/// <summary>
			/// The effector position EffectWeight.
			/// </summary>
			public float effectorPositionWeight;
			/// <summary>
			/// The effector rotation EffectWeight.
			/// </summary>
