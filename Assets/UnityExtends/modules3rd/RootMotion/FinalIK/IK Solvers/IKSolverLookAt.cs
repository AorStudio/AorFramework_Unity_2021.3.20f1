...
namespace RootMotion.FinalIK {
	...
	public class IKSolverLookAt : IKSolver {
		...
		/// <summary>
		/// The body EffectWeight.
		/// </summary>
		[Range(0f, 1f)]
		public float bodyWeight = 0.5f;
		/// <summary>
		/// The head EffectWeight.
		/// </summary>
		[Range(0f, 1f)]
		public float headWeight = 0.5f;
		/// <summary>
		/// The eyes EffectWeight.
		/// </summary>
		[Range(0f, 1f)]
		public float eyesWeight = 1f;
		/// <summary>
		/// Clamp EffectWeight for the body.
		/// </summary>
		[Range(0f, 1f)]
		public float clampWeight = 0.5f;
		/// <summary>
		/// Clamp EffectWeight for the head.
		/// </summary>
		[Range(0f, 1f)]
		public float clampWeightHead = 0.5f;
		/// <summary>
		/// Clamp EffectWeight for the eyes.
		/// </summary>
		[Range(0f, 1f)]
		...
		/// <summary>
		/// Sets the look at EffectWeight. NOTE: You are welcome edit the weights directly, this method is here only to match the Unity's built in %IK API.
		/// </summary>
		...
		/// <summary>
		/// Sets the look at EffectWeight. NOTE: You are welcome to edit the weights directly, this method is here only to match the Unity's built in %IK API.
		/// </summary>
