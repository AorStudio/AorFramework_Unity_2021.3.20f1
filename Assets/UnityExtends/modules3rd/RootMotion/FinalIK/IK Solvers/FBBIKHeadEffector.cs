...
namespace RootMotion.FinalIK {
	...
	public class FBBIKHeadEffector : MonoBehaviour {
		...
		[Tooltip("Master EffectWeight for positioning the head.")]
		[Range(0f, 1f)] public float positionWeight = 1f;

		[Tooltip("The EffectWeight of moving the body along with the head")]
		[Range(0f, 1f)] public float bodyWeight = 0.8f;

		[Tooltip("The EffectWeight of moving the thighs along with the head")]
		...
		[Tooltip("The EffectWeight of rotating the head bone after solving")]
		...
		[Tooltip("The master EffectWeight of bending/twisting the spine to the rotation of the head effector. This is similar to CCD, but uses the rotation of the head effector not the position.")]
		...
		public class BendBone {
			...
			[Tooltip("The EffectWeight of rotating this bone.")]
		...
		[LargeHeader("CCD")]
		[Tooltip("Optional. The master EffectWeight of the CCD (Cyclic Coordinate Descent) IK effect that bends the spine towards the head effector before FBBIK solves.")] 
		[Range(0f, 1f)] public float CCDWeight = 1f;

		[Tooltip("The EffectWeight of rolling the bones in towards the target")]
