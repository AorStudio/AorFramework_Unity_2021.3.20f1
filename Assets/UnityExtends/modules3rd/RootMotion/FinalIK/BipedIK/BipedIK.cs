...
namespace RootMotion.FinalIK {
	...
	public class BipedIK : SolverManager {
		...
		/// <summary>
		/// Gets the %IK position EffectWeight.
		/// </summary>
		/// <param name='goal'>
		/// %IK Goal.
		/// </param>
		...
		/// <summary>
		/// Gets the %IK rotation EffectWeight.
		/// </summary>
		/// <param name='goal'>
		/// IK Goal.
		/// </param>
		...
		/// <summary>
		/// Sets the %IK position EffectWeight.
		/// </summary>
		/// <param name='goal'>
		/// %IK Goal.
		/// </param>
		...
		/// <summary>
		/// Sets the %IK rotation EffectWeight.
		/// </summary>
		/// <param name='goal'>
		/// %IK Goal.
		/// </param>
		...
		/// Clamp EffectWeight for body and head.
		/// </param>
		/// <param name='clampWeightEyes'>
		/// Clamp EffectWeight for eyes.
		/// </param>
