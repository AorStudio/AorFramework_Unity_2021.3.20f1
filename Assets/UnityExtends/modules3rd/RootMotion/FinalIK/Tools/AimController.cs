...
namespace RootMotion.FinalIK {
	...
	/// <summary>
	/// Handles smooth aim target switching, EffectWeight blending, target interpolation and root rotation.
	/// </summary>
	public class AimController : MonoBehaviour {
		...
		[Tooltip("Master EffectWeight of the IK solver.")]
		/// <summary>
		/// Master EffectWeight of the IK solver.
		/// </summary>
		...
		[Tooltip("The time it takes to blend in/out of AimIK EffectWeight.")]
		/// <summary>
		/// The time it takes to blend in/out of AimIK EffectWeight.
		/// </summary>
