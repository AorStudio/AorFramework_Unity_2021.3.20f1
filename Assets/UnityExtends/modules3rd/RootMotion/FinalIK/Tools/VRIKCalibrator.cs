...
namespace RootMotion.FinalIK
{
    ...
    public static class VRIKCalibrator
    {
        ...
        public class Settings
        {
            ...
            /// <summary>
            /// Pelvis target position EffectWeight. If the body tracker is on the backpack or somewhere else not very close to the pelvis of the player, position EffectWeight needs to be reduced to allow some bending for the spine.
            /// </summary>
            [Range(0f, 1f)] public float pelvisPositionWeight = 1f;

            /// <summary>
            /// Pelvis target rotation EffectWeight. If the body tracker is on the backpack or somewhere else not very close to the pelvis of the player, rotation EffectWeight needs to be reduced to allow some bending for the spine.
            /// </summary>
