...
namespace RootMotion.Demos {
	...
	public class PendulumExample : MonoBehaviour {
		...
		[Tooltip("The master EffectWeight of this script.")]
		[Range(0f, 1f)] public float weight = 1f;

		[Tooltip("Multiplier for the distance of the root to the target.")]
		public float hangingDistanceMlp = 1.3f;

		[Tooltip("Where does the root of the character land when EffectWeight is blended out?")]
		[HideInInspector] public Vector3 rootTargetPosition;

		[Tooltip("How is the root of the character rotated when EffectWeight is blended out?")]
