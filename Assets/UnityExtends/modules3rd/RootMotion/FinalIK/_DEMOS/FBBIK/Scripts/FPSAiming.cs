...
namespace RootMotion.Demos {
	...
	public class FPSAiming : MonoBehaviour {
		...
		[Range(0f, 1f)] public float aimWeight = 1f; // The EffectWeight of aiming the gun towards camera forward
		[Range(0f, 1f)] public float sightWeight = 1f; // the EffectWeight of aiming down the sight (multiplied by aimWeight)
