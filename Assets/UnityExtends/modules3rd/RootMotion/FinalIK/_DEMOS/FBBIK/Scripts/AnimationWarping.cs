...
namespace RootMotion.Demos {
	...
	/// The EffectWeight curve of the warp is used to add the offset from "Warp From" to "Warp To" to the effector.
	...
	public class AnimationWarping : OffsetModifier {
		...
		public struct Warp {
			...
			[Tooltip("Warping EffectWeight by normalized time of the animation state.")]
		...
		/// <summary>
		/// Gets the current warping EffectWeight of the warp at the specified index.
		/// </summary>
		public float GetWarpWeight(int warpIndex) {
			...
			// Evaluate the EffectWeight of the warp by the current normalized time of the state
