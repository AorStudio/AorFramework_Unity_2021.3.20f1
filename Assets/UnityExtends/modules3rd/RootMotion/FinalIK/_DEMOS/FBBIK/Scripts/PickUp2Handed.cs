...
namespace RootMotion.Demos {
	...
	public abstract class PickUp2Handed : MonoBehaviour {
		...
		public float pickUpTime = 0.3f; // Maximum lerp speed of the object. Decrease this value to give the object more EffectWeight
		...
		void LateUpdate() {
			if (holding) {
				// Smoothing in the hold EffectWeight
