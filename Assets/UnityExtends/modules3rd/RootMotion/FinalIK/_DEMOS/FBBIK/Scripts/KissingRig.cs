...
namespace RootMotion.Demos {
	...
	public class KissingRig : MonoBehaviour {
		...
		public class Partner {
			...
			public float bodyWeightHorizontal = 0.4f; // The body effector horizontal EffectWeight
			public float bodyWeightVertical = 1f; // The body effector vertical EffectWeight
			public float neckRotationWeight = 0.3f; // The neck rotation EffectWeight
		...
		public float weight; // The master EffectWeight
