...
namespace RootMotion.FinalIK {
	...
	public class Finger {
		...
		/// <summary>
		/// The EffectWeight of rotating the finger tip and bending the finger to the target.
		/// </summary>
		[Tooltip("The EffectWeight of rotating the finger tip and bending the finger to the target.")]
		[Range(0f, 1f)] 
	...
	public class FingerRig : SolverManager {
		...
		/// <summary>
		/// The master EffectWeight for all fingers.
		/// </summary>
		[Tooltip("The master EffectWeight for all fingers.")]
		[Range(0f, 1f)]
