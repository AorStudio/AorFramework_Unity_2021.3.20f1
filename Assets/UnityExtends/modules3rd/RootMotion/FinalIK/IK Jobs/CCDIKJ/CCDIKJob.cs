    ...
    public struct CCDIKJob : UnityEngine.Animations.IAnimationJob
    {
        ...
        public void Setup(Animator animator, Transform[] bones, Transform target)
        {
            ...
            for (int i = 0; i < this.bones.Length - 1; i++)
            {
                ...
                this.boneWeights[i] = animator.BindSceneProperty(bones[i].transform, typeof(IKJBoneParams), "EffectWeight");
            }
            ...
            _IKPositionWeight = animator.BindSceneProperty(animator.transform, typeof(CCDIKJ), "EffectWeight");
        ...
        private void Solve(UnityEngine.Animations.AnimationStream s, Vector3 targetPosition, bool XY, float weight, int it, bool useRotationLimits)
        {
            ...
            {
                //CCD tends to overemphasise the rotations of the bones closer to the target position. Reducing bone EffectWeight down the hierarchy will compensate for this effect.
