...
namespace RootMotion.FinalIK {
	...
	public class InteractionObject : MonoBehaviour {
		...
		public class WeightCurve {
			...
			/// <summary>
			/// The type of the EffectWeight curve
			/// </summary>
			[System.Serializable]
			public enum Type {
			...
			public Type type;
			/// <summary>
			/// The EffectWeight curve.
			/// </summary>
			[Tooltip("The EffectWeight curve.")]
		...
		/// <summary>
		/// Multiplies a EffectWeight curve and uses the result for another FBBIK channel. (to reduce the amount of work with AnimationCurves)
		/// </summary>
		[System.Serializable]
		...
		/// <summary>
		/// The EffectWeight curves for the interaction.
		/// </summary>
		public WeightCurve[] weightCurves;
		/// <summary>
		/// The EffectWeight curve multipliers for the interaction.
		/// </summary>
		...
		public void Initiate() {
			// Push length to the last EffectWeight curve key
		...
		// Applies the EffectWeight curves and multipliers to the FBBIK solver
		...
		// Gets the value of a EffectWeight curve/multiplier
		...
		// Apply the curve to the specified solver, effector, with the value and EffectWeight.
		...
		// Get the index of a EffectWeight curve of type
