...
namespace RootMotion.FinalIK {
	...
	public class InteractionLookAt {
		...
		/// <summary>
		/// Interpolation speed of the LookAtIK EffectWeight.
		/// </summary>
		[Tooltip("Interpolation speed of the LookAtIK EffectWeight.")]
		...
		private float weight; // Current EffectWeight
