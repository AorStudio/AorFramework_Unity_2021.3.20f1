...
namespace RootMotion.FinalIK {
	...
	public class InteractionTarget : MonoBehaviour {
		...
		/// <summary>
		/// Multiplies the value of a EffectWeight curve for this effector target.
		/// </summary>
		[System.Serializable]
		...
		/// <summary>
		/// InteractionObject EffectWeight curve multipliers for this effector target.
		/// </summary>
		[Tooltip("InteractionObject EffectWeight curve multipliers for this effector target.")]
		...
		/// <summary>
		/// The EffectWeight of twisting the interaction target towards the effector bone in the start of the interaction.
		/// </summary>
		[Tooltip("The EffectWeight of twisting the interaction target towards the effector bone in the start of the interaction.")]
		public float twistWeight = 1f;
		/// <summary>
		/// The EffectWeight of swinging the interaction target towards the effector bone in the start of the interaction. Swing is defined as a 3-DOF rotation around any axis, while twist is only around the twist axis.
		/// </summary>
		[Tooltip("The EffectWeight of swinging the interaction target towards the effector bone in the start of the interaction. Swing is defined as a 3-DOF rotation around any axis, while twist is only around the twist axis.")]
