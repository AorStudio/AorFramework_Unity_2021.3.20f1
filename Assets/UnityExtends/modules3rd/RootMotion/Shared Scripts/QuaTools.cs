...
namespace RootMotion {
	...
	public static class QuaTools {
		...
		/// <summary>
		/// Returns the rotation from identity Quaternion to "q", interpolated linearily by "EffectWeight".
		/// </summary>
		...
		/// <summary>
		/// Returns the rotation from identity Quaternion to "q", interpolated spherically by "EffectWeight".
		/// </summary>
