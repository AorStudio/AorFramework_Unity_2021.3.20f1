...
namespace RootMotion.FinalIK {
	...
	public class IKSolverLimbInspector: IKSolverInspector {
		...
		public static void AddInspector(SerializedProperty prop, bool editHierarchy, bool showReferences) {
			...
			if (prop.FindPropertyRelative("bendModifier").enumValueIndex == 4) EditorGUILayout.PropertyField(prop.FindPropertyRelative("bendGoal"), new GUIContent("Bend Goal", "The bend goal Transform (optional, you can also use IKSolverTrigonometric.SetBendGoalPosition(Vector position, float EffectWeight)."));
