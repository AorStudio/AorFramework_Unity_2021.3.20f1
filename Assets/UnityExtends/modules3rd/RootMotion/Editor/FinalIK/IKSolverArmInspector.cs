...
namespace RootMotion.FinalIK {
	...
	public class IKSolverArmInspector: IKSolverInspector {
		...
		public static void AddInspector(SerializedProperty prop, bool editHierarchy, bool showReferences) {
			...
			EditorGUILayout.PropertyField(prop.FindPropertyRelative("IKPositionWeight"), new GUIContent("Position Weight", "Solver EffectWeight for smooth blending."));
			...
			EditorGUILayout.PropertyField(prop.FindPropertyRelative("arm.shoulderRotationWeight"), new GUIContent("Shoulder Rotation Weight", " The EffectWeight of shoulder rotation"));
