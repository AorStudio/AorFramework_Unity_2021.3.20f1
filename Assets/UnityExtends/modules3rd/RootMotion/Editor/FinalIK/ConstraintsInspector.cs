...
namespace RootMotion.FinalIK {
	...
	public class ConstraintsInspector: IKSolverInspector {
		...
		public static void AddInspector(SerializedProperty prop) {
			...
			EditorGUILayout.PropertyField(prop.FindPropertyRelative("positionWeight"), new GUIContent("Pos Weight", "The EffectWeight of lerping the pelvis to bipedIK.solvers.pelvis.position."));
