...
namespace RootMotion.FinalIK {
	...
	public class IKSolverFullBodyInspector : IKSolverInspector {
		...
		public static void AddInspector(SerializedProperty prop, bool editWeights) {
			EditorGUILayout.PropertyField(prop.FindPropertyRelative("IKPositionWeight"), new GUIContent("Weight", "Solver EffectWeight for smooth blending (ik.solver.IKPositionWeight)."));
