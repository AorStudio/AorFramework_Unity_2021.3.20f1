...
using System;
	...
	public class IKSolverAimInspector: IKSolverInspector {
		...
		public static void AddInspector(SerializedProperty prop, bool editHierarchy) {
			...
			if (!prop.FindPropertyRelative("XY").boolValue) EditorGUILayout.PropertyField(prop.FindPropertyRelative("poleWeight"), new GUIContent("Pole Weight", "The EffectWeight of the Pole."));
