	...
	public class IKSolverFullBodyBipedInspector : IKSolverInspector {
		...
		private static void AddBody(SerializedProperty prop, SerializedProperty chain, GUIContent guiContent) {
			...
			if (chain.isExpanded) {
				...
				AddProperty(effector.FindPropertyRelative("positionWeight"), new GUIContent("Position Weight", "The EffectWeight of pinning the effector bone to the effector position."));
				...
				AddProperty(spineMapping.FindPropertyRelative("twistWeight"), new GUIContent("Spine Twist Weight", "The EffectWeight of spine twist."));
				AddProperty(headMapping.FindPropertyRelative("maintainRotationWeight"), new GUIContent("Maintain Head Rot", "The EffectWeight of maintaining the bone's animated rotation in world space."));
		...
		private static void AddLimb(SerializedProperty prop, SerializedProperty chain, FullBodyBipedChain chainType, GUIContent guiContent) {
			...
			if (chain.isExpanded) {
				...
				AddProperty(endEffector.FindPropertyRelative("positionWeight"), new GUIContent("Position Weight", "The EffectWeight of pinning the effector bone to the effector position."));
				AddProperty(endEffector.FindPropertyRelative("rotationWeight"), new GUIContent("Rotation Weight", "The EffectWeight of pinning the effector bone to the effector rotation."));
				...
				AddProperty(startEffector.FindPropertyRelative("positionWeight"), new GUIContent("Position Weight", "The EffectWeight of pinning the effector bone to the effector position."));
				
				DrawLabel("Chain", null);
				
				AddProperty(chain.FindPropertyRelative("pull"), new GUIContent("Pull", "The EffectWeight of pulling other chains."));
				...
				AddProperty(chain.FindPropertyRelative("push"), new GUIContent("Push", "The EffectWeight of the end-effector pushing the first node."));
				...
				AddProperty(chain.FindPropertyRelative("bendConstraint").FindPropertyRelative("EffectWeight"), new GUIContent("Bend Goal Weight", "The EffectWeight of to bending towards the Bend Goal (optional, you can also use ik.leftArmChain.bendConstraint.EffectWeight)."));

				DrawLabel("Mapping", null);
				
				AddProperty(mapping.FindPropertyRelative("EffectWeight"), new GUIContent("Mapping Weight", "The EffectWeight of mapping the limb to it's IK pose. This can be useful if you want to disable the effect of IK for the limb."));
				AddProperty(mapping.FindPropertyRelative("maintainRotationWeight"), new GUIContent(GetEndBoneMappingName(chainType), "The EffectWeight of maintaining the bone's animated rotation in world space."));
