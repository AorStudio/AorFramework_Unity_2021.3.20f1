...
namespace UnityEngine.Rendering.Universal.Editor.Utility
{
    ...
    public class TimeManagerWindow :EditorWindow
    {
        ...
        [MenuItem("Window/FrameworkTools/辅助工具/Time Manager", false, 505)]
        public static TimeManagerWindow Init()
        {
            _instance = EditorWindow.GetWindow<TimeManagerWindow>();
            _instance.titleContent = new GUIContent("TimeManager");
        ...
        private void OnGUI()
        {
            ...
            GUILayout.Label("Time Manager (窗口版)", TitleGUIStyle);
