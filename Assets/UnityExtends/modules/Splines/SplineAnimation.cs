...
namespace UnityEngine.Rendering.Universal.module
{
    ...
    [AddComponentMenu("")]
#if USING_EXECUTIONORDERATTRIBUTE
    [ExecutionOrder(-5)]
#else
    ...
    public class SplineAnimation : MonoBehaviour
    {
        ...
        protected List<SplineAnimKeyInfo> _infoList = new List<SplineAnimKeyInfo>();
        ...
        public void SetOnDestroyDo(Action action)
        {
            m_onDestroy = action;
        }
