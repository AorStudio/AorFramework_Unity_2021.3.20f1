...
namespace UnityEngine.Rendering.Universal.module
{
    ...
    /// A method for numerical integration (whith trapezoidal rule) of the _easeCurve. 
    /// And a method for arc length reparameterization based on the inversion of _easeCurve integration with root-finding algorithms (bisection and newton).
    /// </summary>
    public static class Bezier
    {
        ...
        /// <summary>
        /// Gets the _easeCurve point at t position.
        /// </summary>
        ...
        /// <summary>
        /// Gets the first derivative of the _easeCurve at t position.
        /// </summary>
        /// <param name="p0">First control point.</param>
        /// <param name="p1">Second control point.</param>
        /// <param name="p2">Third control point.</param>
        ...
        /// <summary>
        /// Gets the second derivative of the _easeCurve at t position.
        /// </summary>
        /// <param name="p0">First control point.</param>
        /// <param name="p1">Second control point.</param>
        /// <param name="p2">Third control point.</param>
        ...
        /// <summary>
        /// Integrates numerically with trapezoid rule the _easeCurve first derivative in [t0, t1] obtaining an arc length.
        /// </summary>
        /// <param name="p0">First control point.</param>
        /// <param name="p1">Second control point.</param>
        /// <param name="p2">Third control point.</param>
        ...
        /// <returns>The arc length of the _easeCurve in [t0, t1].</returns>
        ...
        /// <summary>
        /// Integrates numerically with Simpson's rule the _easeCurve first derivative in [t0, t1] obtaining an arc length.
        /// </summary>
        /// <param name="p0">First control point.</param>
        /// <param name="p1">Second control point.</param>
        /// <param name="p2">Third control point.</param>
        ...
        /// <summary>
        /// Integrates numerically with Simpson's 3/8 rule the _easeCurve first derivative in [t0, t1] obtaining an arc length.
        /// </summary>
        /// <param name="p0">First control point.</param>
        /// <param name="p1">Second control point.</param>
        /// <param name="p2">Third control point.</param>
        ...
        /// <summary>
        /// Integrates numerically with Legendre Gauss Quadrature rule the _easeCurve first derivative in [t0, t1] obtaining an arc length.
        /// </summary>
        /// <param name="p0">First control point.</param>
        /// <param name="p1">Second control point.</param>
        /// <param name="p2">Third control point.</param>
        ...
        /// <summary>
        /// Gets the _easeCurve parameter that gives an arc length of s.
        /// </summary>
        /// <param name="p0">First control point.</param>
        /// <param name="p1">Second control point.</param>
        /// <param name="p2">Third control point.</param>
        /// <param name="p3">Forth control point.</param>
        /// <param name="s">The disired arc length s in [0, _easeCurve length].</param>
        ...
        /// <returns>The _easeCurve parameter.</returns>
            ...
            for (int j = 0; j < jmax; j++)
            {
                ...
                else
                {
                    ...
                    if (tCandidate >= upper)
                    {
                        // Candidate is outside the root-bounding interval. Use bisection instead.
                        dt = 0.5f * (upper + lower);
                        //Debug.UiLog("using bisection tCandidate >= upper " + tCandidate + " >= " + upper);
                    }
                    else
                    {
